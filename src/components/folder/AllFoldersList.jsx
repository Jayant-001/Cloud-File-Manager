...
const AllFolderItem = ({ folder }) => {
    return (
        ...
        >
            <div className="w-full mt-3 flex items-center px-3 gap-3 cursor-pointer rounded-lg py-3 shadow shadow-[#1d232a] hover:bg-[#1d232a] hover:scale-105 hover:shadow-md">
                <svg
